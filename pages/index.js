        ...
        <div>
            ...
            >
                <div className={styles.phone}>
                    <img src="/images/image-mockups.png" alt="image" />
                </div>
                ...
                <section className={`${styles.wrap} ${styles.greybackground}`}>
                    <div className={styles.info}>
                        <h2 className={styles.main}>Why choose Easybank?</h2>
                        <p>
            ...
            <section className={`${styles.wrap} ${styles.lightbackground}`}>
                <h2 className={styles.main}> Latest Articles</h2>
                ...
                <div className={styles.grid}>
                    <BoxArticle
                        ...
                        info=" Receive money in any currency with no fees"
                        article="The world is getting smaller and we’re becoming
                    ...
                    <BoxArticle
                        ...
                        info=" Treat yourself without worrying about money"
                    ...
                    <BoxArticle
                        ...
                        author="By Wilson Hutton"
                        info=" Take your Easybank card wherever you go"
                    ...
                    <BoxArticle
                        ...
                        author="By Claire Robinson"
                        info="Our invite-only Beta accounts are now live!"
            ...
            <footer className={`${styles.footer} ${styles.wrap}`}>
                ...
                <div className={`${styles.box} ${styles.position}`}>
                    <Button />
